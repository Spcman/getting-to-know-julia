...
We haven’t yet looked at text data.  Computers are great at storing text data but they don’t ‘understand’ it as such. We can now relatively easily train machine learning models to recognize the sentiment of text.  Probably the most famous dataset used by newbies for this task is the IMDB movie reviews dataset. This dataset contains over 50,000 reviews. Each movie review has been manually labelled as a positive or negative review. If we train a machine learning model on this data we can take a new review and work out if it is positive or negative.
