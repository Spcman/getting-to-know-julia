...
The posts and pages are markdown files (.md) which makes them quick to edit.  The super cool thing is that can save your Notebooks as markdown files from Jupyter and the output file only requires a small amount of editing to make it look good on the Jekyll website. 
